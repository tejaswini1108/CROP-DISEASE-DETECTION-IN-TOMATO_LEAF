...
filepath = 'C:/Users/sahit/OneDrive/Desktop/Plant-Leaf-Disease-Prediction/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/sahit/OneDrive/Desktop/Plant-Leaf-Disease-Prediction/Dataset/train/Tomato - Bacterial_spot/Tomato___Bacterial_spot (1).JPG')
